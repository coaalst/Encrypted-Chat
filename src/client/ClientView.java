...
public class ClientView extends JFrame{
	...
	public ClientView(Socket client, RSA encrypt, RSA decryptor, ClientInputModul cim) throws IOException {
		...
		appendToPane(ta, "Dobrodosao na R45 chat. Chat pod RSA encryption\n", Color.BLUE);
		...
		tf.addKeyListener(new KeyAdapter() {
	        ...
	        public void keyPressed(KeyEvent e) {
	            if(e.getKeyCode() == KeyEvent.VK_ENTER){
					...
					else if (tf.getText().toLowerCase().startsWith(":changepassword")) {
						socket_out.println(encrypt.encryptString("changePassword: " + tf.getText()));
					}
